...
# Change the schema in EINSTEINAI4DB-imdb/deepdb_job_ranges/schemas/imdb/schema.py/def gen_job_ranges_imdb_schema first
# Modify parameters for your own: ensemble_path, target_path, ensemble_location

# Set the working directory
cd /Users/xaxpmore/Documents/GitHub/DiabloGPT/AML/Transformers/deepdb/power.sh

# Generate HDF and sampled HDFs
...
# Evaluate cardinalities and perform RDC-SPN selection
